...
export async function runExamplesAction() {
  ...
  console.log(chalk.gray('   mcp-verify validate http://localhost:3000 --html'));
  console.log(chalk.dim('   → ' + t('example_2_desc') + '\n'));

  console.log(chalk.cyan('3. ' + t('load_testing')));
  console.log(chalk.gray('   mcp-verify stress http://localhost:3000 --users 10 --duration 30'));
  ...
  console.log(chalk.gray('   mcp-verify validate http://localhost:3000 --format sarif'));
  ...
  console.log(chalk.gray('   node examples/servers/dummy-server.js    (' + t('working_server') + ')'));
  console.log(chalk.gray('   node examples/servers/broken-server.js   (' + t('error_testing_server') + ')\n'));
}
