...
build({
  ...
  .then(() => {
    ...
    if (stat.size < 100) {
      throw new Error(
        `dist/extension.js se generó pero parece vacío (${stat.size} bytes). Revisá los logs arriba.`,
      );
    }
    console.log(
