...
describe('ReDoSDetectionRule', () => {
    ...
    describe('should detect vulnerabilities', () => {
        it('should detect nested quantifiers (Medium)', () => {
            ...
            expect(finding!.message).toContain('has a vulnerable regex pattern that can lead to ReDoS');
        ...
        it('should warn about missing anchors (Low)', () => {
            ...
            expect(anchorFinding!.message).toContain('is not anchored, which can lead to inefficient matching');
        });
    });
