...
describe('Layout Primitives', () => {
  ...
  describe('wordWrap()', () => {
    ...
    it('should wrap long text at word boundaries', () => {
      const text = 'This is a very long line that should be wrapped at word boundaries';
  ...
  describe('FindingCard()', () => {
    it('should render complete finding card with all fields', () => {
      const data: FindingCardData = {
        ...
        cwe: 'CWE-89',
        payloads: ["'; DROP TABLE users--", "' OR '1'='1", "' UNION SELECT * FROM passwords--"],
      ...
      expect(result).toContain('1. [!!!] SQL Injection vulnerability detected (x3)');
  ...
  describe('groupFindingsBySeverity()', () => {
    ...
    it('should preserve severity order', () => {
      const findings: SecurityFinding[] = [
        ...
        { rule: 'R2', severity: 'critical', message: 'Critical', component: 'c2' },
