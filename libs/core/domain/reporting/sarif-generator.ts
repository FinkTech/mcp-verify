...
export class SarifGenerator {
  static generate(report: Report, lang: Language = "en"): string {
    ...
    const run: Record<string, unknown> = {
      ...
      results: report.security.findings.map((finding) =>
        this.mapFindingToResult(finding),
      ),
    };
  ...
  private static extractRules(report: Report, lang: Language = "en") {
    ...
    const allRules = [
      ...
      },
      {
        ...
        shortDescription: {
          text: t("sec_command_injection_desc", undefined, lang),
        },
      ...
      },
      {
        ...
        shortDescription: {
          text: t("sec_sql_injection_desc", undefined, lang),
        },
      ...
      },
      {
        ...
        shortDescription: {
          text: t("sec_insecure_deserialization_desc", undefined, lang),
        },
      ...
      },
      {
        ...
        shortDescription: {
          text: t("sec_path_traversal_desc", undefined, lang),
        },
      ...
      },
      {
        ...
        shortDescription: {
          text: t("sec_sensitive_exposure_desc", undefined, lang),
        },
      ...
      },
      {
        ...
        shortDescription: {
          text: t("sec_rate_limiting_desc", undefined, lang),
        },
