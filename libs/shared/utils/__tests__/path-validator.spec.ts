...
describe("PathValidator", () => {
  ...
  describe("validateOutputPath", () => {
    it("should allow paths within base directory", () => {
      ...
      const result = PathValidator.validateOutputPath(
        "custom/report.json",
        baseDir,
      );
  ...
  describe("validateBaselinePath", () => {
    ...
    it("should allow baseline in subdirectories", () => {
      const result = PathValidator.validateBaselinePath(
    ...
    it("should block complex traversals", () => {
      expect(() => {
        PathValidator.validateBaselinePath(
          "./foo/../../bar/../../../tmp/baseline.json",
        );
      }).toThrow(/outside project directory/);
    });
  });
  ...
  describe("isSafeOutputPath", () => {
    it("should return true for safe paths", () => {
      ...
      expect(
        PathValidator.isSafeOutputPath("custom/report.html", baseDir),
      ).toBe(true);
    });
    ...
    it("should return false for unsafe paths", () => {
      ...
      expect(
        PathValidator.isSafeOutputPath("../../../etc/passwd", baseDir),
      ).toBe(false);
      expect(PathValidator.isSafeOutputPath("/etc/passwd", baseDir)).toBe(
        false,
      );
    });
  });
  ...
  describe("isSafeBaselinePath", () => {
    ...
    it("should return true for safe baseline paths", () => {
      ...
      expect(PathValidator.isSafeBaselinePath("config/baseline.json")).toBe(
        true,
      );
    });
    ...
    it("should return false for unsafe baseline paths", () => {
      expect(
        PathValidator.isSafeBaselinePath("../../outside/baseline.json"),
      ).toBe(false);
      expect(PathValidator.isSafeBaselinePath("/tmp/baseline.json")).toBe(
        false,
      );
    });
  });
