...
export class RawProtocolGenerator implements IPayloadGenerator {
  ...
  readonly description =
    "Tests transport layer with malformed JSON, JSON-RPC violations, and batch attacks";
    ...
    return [
      // Truncated JSON
      {
        ...
        expectedVulnerableBehavior:
          "Server hangs waiting for more data or crashes",
        tags: ["parser", "dos"],
      ...
      },
      {
        ...
        expectedVulnerableBehavior:
          "Server ignores trailing data (could hide attacks)",
  ...
  private generateJsonRpcViolations(): GeneratedPayload[] {
    return [
      ...
      },
      {
        ...
        expectedVulnerableBehavior:
          "Server crashes or executes undefined behavior",
        tags: ["jsonrpc", "spec-violation"],
        metadata: { isRaw: true },
      },
  ...
  private generateDoSPayloads(): GeneratedPayload[] {
    ...
    payloads.push({
      ...
      expectedVulnerableBehavior:
        "Infinite loop if using JSON schema dereferencing",
      tags: ["dos", "circular"],
      metadata: { isRaw: true, sendAsString: true },
    });
  ...
  private generateEncodingAttacks(): GeneratedPayload[] {
    return [
      ...
      {
        value: Buffer.from([
          0x7b, 0x22, 0x6a, 0x73, 0x6f, 0x6e, 0x72, 0x70, 0x63, 0x22, 0x3a,
          0x22, 0x32, 0x2e, 0x30, 0x22, 0x7d,
        ]).toString(),
        category: "raw-protocol",
        type: "raw-bytes",
        severity: "low",
  ...
  private generateNullByteAttacks(): GeneratedPayload[] {
    return [
      {
        value:
          '{"jsonrpc": "2.0", "method": "tools/list\x00injected", "id": 1}',
        category: "raw-protocol",
      ...
      {
        value:
          '{"jsonrpc": "2.0", "method": "tools/list", "id": 1, "extra": "before\x00after"}',
        category: "raw-protocol",
