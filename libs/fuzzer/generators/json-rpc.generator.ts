...
export class JsonRpcGenerator implements IPayloadGenerator {
  ...
  readonly description = 'Generates malformed JSON-RPC requests to test protocol robustness';
  ...
  private generateMalformedStructure(): GeneratedPayload[] {
    return [
      ...
      {
        value: { jsonrpc: '2.0', method: 'test', id: 1, extra: 'field', another: 'one' },
        category: 'protocol',
        type: 'extra-fields',
        severity: 'low',
  ...
  private generateInvalidIds(): GeneratedPayload[] {
    return [
      ...
      {
        value: { jsonrpc: '2.0', method: 'test', id: Number.MAX_SAFE_INTEGER + 1 },
        category: 'protocol',
        type: 'overflow-id',
        severity: 'medium',
  ...
  private generateParamsAttacks(): GeneratedPayload[] {
    return [
      ...
      {
        value: { jsonrpc: '2.0', method: 'tools/call', id: 1, params: 'string instead of object' },
        category: 'protocol',
        type: 'string-params',
        severity: 'medium',
      ...
      {
        value: { jsonrpc: '2.0', method: 'tools/call', id: 1, params: { __proto__: { admin: true } } },
        category: 'protocol',
      ...
      {
        value: { jsonrpc: '2.0', method: 'tools/call', id: 1, params: { constructor: { prototype: { admin: true } } } },
        category: 'protocol',
