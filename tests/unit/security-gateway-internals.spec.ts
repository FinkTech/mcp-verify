...
describe('Security Gateway - Internal Behavior (Unit Tests)', () => {
  ...
  describe('Cache Behavior', () => {
    it('should cache identical requests (same method + params)', async () => {
      ...
      const secEvents = auditEvents.filter(e => e.type === 'security-analysis');
  ...
  describe('Suspicious Tool Detection (Layer 2 Activation)', () => {
    ...
    it('should NOT detect benign tools as suspicious', async () => {
      const benignTools = ['get_user', 'fetch_data', 'calculate_sum', 'format_text'];
  ...
  describe('Rule Layer Classification', () => {
    it('should classify Fast Rules correctly (19 rules)', () => {
      const fastRuleIds = [
        ...
        'SEC-008', 'SEC-009', 'SEC-011', 'SEC-012', 'SEC-013', 'SEC-016',
        'SEC-018', 'SEC-019', 'SEC-021', 'SEC-028', 'SEC-032', 'SEC-050',
      ];
    ...
    it('should classify Suspicious Rules correctly (20 rules)', () => {
      const suspiciousRuleIds = [
        'SEC-014', 'SEC-015', 'SEC-017', 'SEC-020', 'SEC-022', 'SEC-023',
        'SEC-024', 'SEC-026', 'SEC-030', 'SEC-033', 'SEC-034', 'SEC-036',
        'SEC-039', 'SEC-040', 'SEC-041', 'SEC-042', 'SEC-043', 'SEC-045',
        'SEC-046', 'SEC-047',
      ];
    ...
    it('should classify LLM Rules correctly (11 rules)', () => {
      const llmRuleIds = [
        'SEC-025', 'SEC-027', 'SEC-029', 'SEC-031', 'SEC-035', 'SEC-037',
        'SEC-038', 'SEC-051', 'SEC-052', 'SEC-055', 'SEC-056',
      ];
