 ...
 * SEC-013: Prompt Injection Detection Test (Static Validation)
 */
...
describe('SEC-013: Prompt Injection Detection (Static)', () => {
  let serverManager: TestServerManager;
  const testReportDir = path.resolve(__dirname, '../../__test-reports__/sec-013');
  ...
  it('should detect prompt injection vulnerability (SEC-013)', async () => {
