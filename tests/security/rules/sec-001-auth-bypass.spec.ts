 ...
 * SEC-001: Authentication Bypass Detection Test
 */
...
describe('SEC-001: Authentication Bypass Detection', () => {
  let serverManager: TestServerManager;
  const testReportDir = path.resolve(__dirname, '../../__test-reports__/sec-001');
  ...
  it('should detect authentication bypass (SEC-001)', async () => {
