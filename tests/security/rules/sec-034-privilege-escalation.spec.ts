 ...
 * SEC-034: Multi-Agent Privilege Escalation Detection Test
 */
...
describe('SEC-034: Multi-Agent Privilege Escalation Detection', () => {
  ...
  it('should detect multi-agent privilege escalation (SEC-034)', async () => {
