 ...
 * SEC-037: Cross-Agent Prompt Injection Detection Test
 */
...
describe('SEC-037: Cross-Agent Prompt Injection Detection', () => {
  ...
  it('should detect cross-agent prompt injection (SEC-037)', async () => {
