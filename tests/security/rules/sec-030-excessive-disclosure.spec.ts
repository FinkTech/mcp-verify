 ...
 * SEC-030: Excessive Data Disclosure Detection Test
 */
...
describe('SEC-030: Excessive Data Disclosure Detection', () => {
  ...
  it('should detect excessive data disclosure (SEC-030)', async () => {
