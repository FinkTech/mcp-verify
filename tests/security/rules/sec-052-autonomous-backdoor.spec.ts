 ...
 * SEC-052: Autonomous MCP Backdoor Detection Test
 */
...
describe('SEC-052: Autonomous MCP Backdoor Detection', () => {
  ...
  it('should detect autonomous mcp backdoor (SEC-052)', async () => {
