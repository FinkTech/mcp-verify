 ...
 * SEC-049: Timing Side Channel Auth Detection Test
 */
...
describe('SEC-049: Timing Side Channel Auth Detection', () => {
  ...
  it('should detect timing side channel auth (SEC-049)', async () => {
