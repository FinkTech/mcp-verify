 ...
 * SEC-022: Insecure Output Handling Detection Test
 */
...
describe('SEC-022: Insecure Output Handling Detection', () => {
  ...
  it('should detect insecure output handling (SEC-022)', async () => {
