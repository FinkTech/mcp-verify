 ...
 * SEC-060: Missing Transaction Semantics Detection Test
 */
...
describe('SEC-060: Missing Transaction Semantics Detection', () => {
  ...
  it('should detect missing transaction semantics (SEC-060)', async () => {
