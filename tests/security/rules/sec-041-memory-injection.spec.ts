 ...
 * SEC-041: Agent Memory Injection Detection Test
 */
...
describe("SEC-041: Agent Memory Injection Detection", () => {
  let serverManager: TestServerManager;
  const testReportDir = path.resolve(
    __dirname,
    "../../__test-reports__/sec-041",
  );
  ...
  it("should detect agent memory injection (SEC-041)", async () => {
