 ...
 * SEC-054: API Endpoint Hijacking Detection Test
 */
...
describe('SEC-054: API Endpoint Hijacking Detection', () => {
  ...
  it('should detect api endpoint hijacking (SEC-054)', async () => {
    ...
    await runValidationAction(target, { 
      ...
      quiet: true, 
      html: false,
      rules: 'OWASP,MCP,A,B,C,D' // Explicitly enable all blocks including D
    });
