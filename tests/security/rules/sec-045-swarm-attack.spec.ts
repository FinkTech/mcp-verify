 ...
 * SEC-045: Agent Swarm Coordination Attack Detection Test
 */
...
describe('SEC-045: Agent Swarm Coordination Attack Detection', () => {
  ...
  it('should detect agent swarm coordination attack (SEC-045)', async () => {
    ...
    expect(finding.message.toLowerCase()).toMatch(/swarm|coordinate|attack|intent/);
