 ...
 * SEC-040: Missing Rate Limiting Detection Test
 */
...
describe('SEC-040: Missing Rate Limiting Detection', () => {
  ...
  it('should detect missing rate limiting (SEC-040)', async () => {
    ...
    expect(finding.message.toLowerCase()).toMatch(/rate.?limit|throttl|dos|expensive|thousands/);
