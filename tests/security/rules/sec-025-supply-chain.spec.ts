 ...
 * SEC-025: Supply Chain Tool Dependencies Detection Test
 */
...
describe("SEC-025: Supply Chain Tool Dependencies Detection", () => {
  let serverManager: TestServerManager;
  const testReportDir = path.resolve(
    __dirname,
    "../../__test-reports__/sec-025",
  );
  ...
  it("should detect supply chain tool dependencies (SEC-025)", async () => {
