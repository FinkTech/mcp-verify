 ...
 * SEC-045: Insufficient Error Granularity Detection Test
 */
...
describe('SEC-045: Insufficient Error Granularity Detection', () => {
  let serverManager: TestServerManager;
  const testReportDir = path.resolve(__dirname, '../../__test-reports__/sec-045');
  ...
  it('should detect insufficient error granularity (SEC-045)', async () => {
