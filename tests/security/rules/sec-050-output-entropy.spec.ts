 ...
 * SEC-050: Insufficient Output Entropy Detection Test
 */
...
describe('SEC-050: Insufficient Output Entropy Detection', () => {
  ...
  it('should detect insufficient output entropy (SEC-050)', async () => {
