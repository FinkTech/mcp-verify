 ...
 * SEC-059: Unvalidated Tool Authorization Detection Test
 */
...
describe('SEC-059: Unvalidated Tool Authorization Detection', () => {
  ...
  it('should detect unvalidated tool authorization (SEC-059)', async () => {
