 ...
 * SEC-044: Schema Versioning Absent Detection Test
 */
...
describe('SEC-044: Schema Versioning Absent Detection', () => {
  ...
  it('should detect schema versioning absent (SEC-044)', async () => {
