 ...
 * SEC-006: Insecure Deserialization Detection Test
 */
...
describe('SEC-006: Insecure Deserialization Detection', () => {
  ...
  it('should detect insecure deserialization (SEC-006)', async () => {
