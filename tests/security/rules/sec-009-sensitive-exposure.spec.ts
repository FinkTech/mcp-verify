 ...
 * SEC-009: Sensitive Data Exposure Detection Test
 */
...
describe('SEC-009: Sensitive Data Exposure Detection', () => {
  let serverManager: TestServerManager;
  const testReportDir = path.resolve(__dirname, '../../__test-reports__/sec-009');
  ...
  it('should detect sensitive data exposure (SEC-009)', async () => {
    ...
    const finding = report.security.findings.find((f: any) => f.ruleCode === 'SEC-009');
