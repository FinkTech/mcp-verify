 ...
 * SEC-031: Agent Identity Spoofing Detection Test
 */
...
describe('SEC-031: Agent Identity Spoofing Detection', () => {
  ...
  it('should detect agent identity spoofing (SEC-031)', async () => {
