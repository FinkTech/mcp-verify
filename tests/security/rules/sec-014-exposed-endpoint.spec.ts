 ...
 * SEC-014: Exposed Endpoint Detection Test
 */
...
describe('SEC-014: Exposed Endpoint Detection', () => {
  let serverManager: TestServerManager;
  const testReportDir = path.resolve(__dirname, '../../__test-reports__/sec-014');
  ...
  it('should detect exposed endpoint (SEC-014)', async () => {
