 ...
 * SEC-027: Training Data Poisoning Detection Test
 */
...
describe('SEC-027: Training Data Poisoning Detection', () => {
  ...
  it('should detect training data poisoning (SEC-027)', async () => {
