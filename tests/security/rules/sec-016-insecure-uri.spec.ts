 ...
 * SEC-016: Insecure URI Scheme Detection Test
 */
...
describe('SEC-016: Insecure URI Scheme Detection', () => {
  let serverManager: TestServerManager;
  const testReportDir = path.resolve(__dirname, '../../__test-reports__/sec-016');
  ...
  it('should detect insecure uri scheme (SEC-016)', async () => {
