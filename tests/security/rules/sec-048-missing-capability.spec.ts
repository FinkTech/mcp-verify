 ...
 * SEC-048: Missing Capability Negotiation Detection Test
 */
...
describe('SEC-048: Missing Capability Negotiation Detection', () => {
  ...
  it('should detect missing capability negotiation (SEC-048)', async () => {
