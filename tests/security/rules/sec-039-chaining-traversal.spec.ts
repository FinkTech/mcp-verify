 ...
 * SEC-039: Tool Chaining Path Traversal Detection Test
 */
...
describe('SEC-039: Tool Chaining Path Traversal Detection', () => {
  ...
  it('should detect tool chaining path traversal (SEC-039)', async () => {
